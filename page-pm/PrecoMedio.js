...
function calcularPrecoMedio() {
    ...
    var valorGasto = document.getElementById("valor_gasto").value;
    var quantidade = document.getElementById("quantidade").value;
    var precoDeMercado = document.getElementById("moeda").value;

    // checar se os valores são válidos
    if (valorGasto <= 0 || quantidade <= 0 || precoDeMercado <= 0) {
        // exibir uma mensagem de erro
        document.getElementById("erro").style.display = 'flex';
        document.getElementById("erro").innerHTML = "VALORES INVÁLIDOS";
        ...
        var precoMedio = valorGasto / quantidade;

        // exibir o resultado
        document.getElementById("resultado").innerHTML = precoMedio;
        ...
        var diferenca = precoMedio - precoDeMercado;
        var diferencaPercentual = (diferenca / precoDeMercado) * 100;

        // exibir o resultado
        document.getElementById("impacto").innerHTML = diferencaPercentual + "<strong>%</strong>";
    }
}
